                                    ...
                                    <div className="relative flex items-center justify-center py-2">
                                        <svg className="w-40 h-40 -rotate-90">
                                            ...
                                            <motion.circle
                                                ...
                                                className={growthStages[currentScreen].textColor}
                                                strokeLinecap="round"
                                            />
                                        </svg>
                                        <div className="absolute flex flex-col items-center">
                                            <div className={`text-5xl font-black tabular-nums tracking-tighter ${growthStages[currentScreen].textColor} drop-shadow-2xl`}>
