  ...
  return (
    <section className="py-24 px-6 relative" ref={ref} id="try-it">
      <div className="max-w-2xl mx-auto">
        ...
        >
          <p className="text-sm uppercase tracking-widest text-text-muted mb-3 font-mono font-bold">
            Interactive Preview
          </p>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-text-primary tracking-tighter leading-[1.1]">
            Try the Experience
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="backdrop-blur-xl bg-black/60 rounded-[2.5rem] p-3 md:p-5 shadow-2xl flex flex-col min-h-[500px] border border-white/5"
        >
          {/* Header */}
          <div className="px-4 py-4 flex items-center gap-3">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <div className="h-2.5 bg-white/10 rounded-full overflow-hidden relative">
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor: timeLeft < 10 && started ? "#ef4444" : "#facc15"
                  }}
                  transition={{
              ...
              <div className="flex gap-1.5 px-0.5">
                {questions.map((_, i) => (
                  <div
                    key={i}
                    className={`h-1 flex-1 rounded-full transition-all duration-300 ${i < currentQuestion ? "bg-yellow-400" :
            ...
            <div className="bg-yellow-400 px-3 py-1.5 rounded-md min-w-[50px] text-center">
              <span className={`text-sm font-black tabular-nums transition-colors ${timeLeft < 10 ? "text-red-600" : "text-black"}`}>
                {timeLeft}s
              </span>
            </div>
          </div>
            ...
            <AnimatePresence mode="wait">
              {!started ? (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-primary mb-1">Test Your Knowledge</h3>
                    <p className="text-text-secondary text-xs px-6 font-medium">
                  ...
                  <div className="w-full space-y-2">
                    <label className="block text-text-muted text-[10px] uppercase tracking-wider font-bold text-center">
                      Choose Your Book
                    </label>
                      ...
                      {availableBooks.map((book) => (
                        <button
                          ...
                          className={`px-4 py-2.5 rounded-full font-bold text-xs transition-all border-2 ${selectedBook === book
                            ...
                            : 'bg-white/5 text-text-primary border-white/10 hover:border-yellow-400/50'
                            }`}
                        >
                          {book}
                        </button>
                  ...
                  <button
                    ...
                    className="w-full bg-yellow-400 hover:bg-yellow-500 text-black py-3 rounded-xl font-black text-base transition-colors mt-auto uppercase tracking-wider shadow-lg"
                  >
                    Start Quiz
                  </button>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <motion.div
                      ...
                      className="mt-4"
                    >
                      <p className="text-yellow-400 font-black text-4xl mb-1">
                        {score * 10} XP
                      </p>
                  ...
                  <div className="space-y-3 w-full">
                    <button
                      onClick={onJoinClick}
                      className="w-full bg-yellow-400 hover:bg-yellow-500 text-black py-3 rounded-xl font-black text-base transition-colors uppercase tracking-wider shadow-lg"
                    >
                      Join waitlist
                    </button>
                    <button
                ...
                >
                  ...
                  <AnimatePresence>
                    {showXP && (
                      <motion.div
                        ...
                        className="absolute top-1/2 left-1/2 -track-x-1/2 -track-y-1/2 z-50 pointer-events-none"
                        style={{ left: '50%', transform: 'translateX(-50%)' }}
                      >
                        <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-8 py-4 rounded-2xl shadow-2xl font-black text-3xl">
                          +10 XP
                        </div>
                      </motion.div>
                    )}
                  ...
                  <h3 className="text-xl md:text-2xl font-black text-text-primary leading-[1.2] mb-6">
                    {q.question}
                  </h3>
                  ...
                  <div className="space-y-3 flex-1">
                    {q.options.map((option, i) => {
                      ...
                      let optionClass = "bg-white/5 border-white/5 text-text-secondary hover:border-yellow-400/30";

                      if (isSelected) {
                        optionClass = "bg-yellow-400/10 border-yellow-400/50 text-text-primary";
                      }
                      ...
                      if (answered) {
                        if (isCorrect) {
                          ...
                          optionClass = "bg-transparent opacity-40 border-transparent text-text-muted";
                        }
                      }
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`w-6 h-6 rounded-full border-4 shrink-0 transition-colors ${answered
                            ...
                            : "border-white/10 group-hover:border-yellow-400/50"
                            }`} />
                        </button>
                      );
                    })}
                  ...
                  <div className="mt-6 pt-3">
                    {answered ? (
                      <button
                        ...
                        className="w-full bg-yellow-400 text-black py-3 rounded-xl font-black text-base transition-colors uppercase tracking-wider shadow-lg"
                      >
                    ...
                    {answered && (
                      <motion.p
                        ...
                        className="text-center mt-4 text-text-muted text-sm font-medium italic px-4"
                      >
